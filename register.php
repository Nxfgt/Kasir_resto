...
<html lang="en">
    <head>
        ...
        <title>Register Aplilkasi Kasir</title>
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="Nama Lengkap" type="Nama Lengkap" name="nama" placeholder="masukkan Nama Lengkap" />
                                                <label for="Nama Lengkap">Masukkan Nama Lengkap</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="username" type="username" name="username" placeholder="masukkan username" />
